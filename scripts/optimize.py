...
class Optimize(object):
    ...
    def __init__(
        ...
        assert (
            type(self.init_train_x) is list
        ...
        assert (
            len(self.init_train_x) == self.num_initialization_points
        ...
        assert (
            self.init_train_y.shape[0] == self.num_initialization_points
        ...
        assert (
            self.init_train_z.shape[0] == self.num_initialization_points
