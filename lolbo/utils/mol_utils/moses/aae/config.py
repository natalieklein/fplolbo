...
def get_parser(parser=None):
    ...
    model_arg.add_argument(
        "--latent_size", type=int, default=128, help="Size of latent vectors"
    )
    model_arg.add_argument(
    ...
    train_arg.add_argument(
        "--step_size", type=float, default=20, help="Period of learning rate decay"
    )
    train_arg.add_argument(
        "--gamma",
        type=float,
    ...
    train_arg.add_argument(
        ...
        type=int,
        default=1,
        help="Discriminator training steps per one" "autoencoder training step",
    )
    train_arg.add_argument(
        "--weight_decay", type=int, default=0, help="weight decay for optimizer"
    )
