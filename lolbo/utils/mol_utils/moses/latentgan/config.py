...
def get_parser(parser=None):
    ...
    train_arg.add_argument(
        "--gp", type=int, default=10, help="Gradient Penalty Coefficient"
    )
    train_arg.add_argument(
        "--n_critic",
        type=int,
    ...
    train_arg.add_argument("--lr", type=float, default=0.0002, help="Learning rate")
    train_arg.add_argument(
        "--b1", type=float, default=0.5, help="Adam optimizer parameter beta 1"
    )
    train_arg.add_argument(
        "--b2", type=float, default=0.999, help="Adam optimizer parameter beta 2"
    )
    train_arg.add_argument(
        "--step_size", type=int, default=10, help="Period of learning rate decay"
    )
    train_arg.add_argument(
        "--latent_vector_dim", type=int, default=512, help="Size of latentgan vector"
    )
    train_arg.add_argument(
        "--gamma",
        type=float,
